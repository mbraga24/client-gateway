package com.clienthub.gateway.exception;

import com.clienthub.gateway.exception.custom.*;
...
public class ClientHubExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleIPApiException(IPApiException ex) {
        ErrorResponse errorResponse = new ErrorResponse(
